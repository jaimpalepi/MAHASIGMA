...
>
  ...
  >
    <a href="/">
      <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
        <img class="block dark:hidden" src="\image\logo_kemahasiswaan-1.png" alt="Logo" />
        <img class="hidden dark:block" src="\image\logo_kemahasiswaan-1.png" alt="Logo" />
      </span>
  ...
  >
    ...
    <nav x-data="{
    selected: '{{ 
        Route::is('admin.settings') || Route::is('admin.layanan') ? 'Dashboard' :
        (Route::is('dispen.*') ? 'Dispen' : 
        (Route::is('admin.artikel.*') ? 'Tables' : 
        (Route::is('admin.pages.*') ? 'Pages' : '')))
    }}'
}">
      <!-- Menu Group -->
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            <a
              href="{{ route('dispen.index') }}"
              @click="selected = (selected === 'Dispen' ? '':'Dispen')"
              class="menu-item group"
              :class="selected === 'Dispen' ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
                :class="selected === 'Dispen' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <li>
            ...
            >
              <svg
                :class="selected === 'Tables' ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <!-- <li>
            ...
            >
              <svg
                :class="selected === 'Pages' ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
