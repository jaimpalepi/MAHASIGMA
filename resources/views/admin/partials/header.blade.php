  ...
  >
    ...
    >
      <div class="2xsm:gap-3 flex items-center gap-2">
        ...
        <!-- Back to Home Button -->
        <a href="{{ url('/') }}" 
           class="inline-flex items-center justify-center rounded-md border-[0.5px] border-stroke bg-gray px-4 py-2 hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white">
