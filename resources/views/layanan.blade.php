...
<div class="flex flex-col space-y-4">
    ...
    <div class="md:col-span-2 bg-gray-200 p-6 rounded transition duration-300">
        ...
        <div x-show="layanan === 'kemahasiswaan'" x-transition>
            ...
            <p class="text-sm mb-4">UNSOED menyediakan berbagai fasilitas penunjang mahasiswa, mulai dari organisasi, pelatihan, hingga kegiatan sosial dan akademik.</p>
        </div>

        <!-- Beasiswa -->
        <div x-show="layanan === 'beasiswa'" x-transition>
            <h2 class="text-xl font-bold mb-3">Beasiswa</h2>
            <p class="text-sm mb-4">Tersedia berbagai jenis beasiswa seperti KIP-Kuliah, PPA, dan beasiswa dari mitra industri yang mendukung pembiayaan studi mahasiswa.</p>
        </div>

        <!-- Proposal Kegiatan -->
        <div x-show="layanan === 'proposal'" x-transition>
            <h2 class="text-xl font-bold mb-3">Proposal Kegiatan</h2>
            <p class="text-sm mb-4">Mahasiswa dapat mengajukan proposal kegiatan organisasi untuk mendapatkan dukungan dan pendanaan dari universitas.</p>
        </div>
