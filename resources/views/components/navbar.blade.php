        ...
        <li>
            ...
            <div id="dropdownTentangKami" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                  <li><a href="#" class="block px-4 py-2 hover:bg-red-100 hover:text-red-700 dark:hover:bg-gray-600 dark:hover:text-white">Visi Misi</a></li>
                  <li><a href="#" class="block px-4 py-2 hover:bg-red-100 hover:text-red-700 dark:hover:bg-gray-600 dark:hover:text-white">Struktur</a></li>
                </ul>
            </div>
        </li>
        <li>
            ...
            <div id="dropdownLayanan" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                  <li><a href="#" class="block px-4 py-2 hover:bg-red-100 hover:text-red-700 dark:hover:bg-gray-600 dark:hover:text-white">Beasiswa</a></li>
                  <li><a href="#" class="block px-4 py-2 hover:bg-red-100 hover:text-red-700 dark:hover:bg-gray-600 dark:hover:text-white">Dispensasi</a></li>
                </ul>
            </div>
        </li>
        <li>
