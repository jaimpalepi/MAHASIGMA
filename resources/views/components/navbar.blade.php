<div
        ...
        <div class="flex justify-end items-center gap-[20px]">
            @if (Auth::user()->role == 'admin')
                ...
                <div class="hidden md:inline-flex rounded-md shadow-sm" role="group">
                    <a href="{{ route('artikel.index') }}"
                        ...
                        Kembali ke Kemahasiwaan
                    </a>
                    <a href="{{ route('beasiswa.table') }}"
                        class="px-6 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 whitespace-nowrap transition-all ease-in-out">
                        Daftar Beasiswa
                    </a>
            ...
            <div
                ...
                {{-- <a href="{{ route('applicant') }}"
                    ...
                    Pendaftar</a> --}}
                <a href="{{ route('artikel.index') }}"
                    class="leading-none p-[15px] w-full box-border text-right hover:bg-gray-200 transition-all ease-in-out">Kembali
                    ke Kemahasiswaan</a>
                <a href="{{ route('beasiswa.table') }}"
                    class="leading-none p-[15px] w-full box-border text-right hover:bg-gray-200 transition-all ease-in-out">Daftar
                    Beasiswa</a>
                <a href="{{ route('beasiswa.create') }}"
                    class="leading-none p-[15px] w-full box-border text-right hover:bg-gray-200 transition-all ease-in-out">Tambah
                    Beasiswa</a>
                <a href="{{ route('logout') }}"
    ...
    @else
        <div class="flex justify-end items-center gap-[20px]">
            ...
            <div class="hidden lg:flex md:inline-flex rounded-md shadow-sm" role="group">
                <a href="{{ route('artikel.index') }}"
                    class="px-6 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-l-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 whitespace-nowrap transition-all ease-in-out">
                    Kembali ke Kemahasiwaan
                </a>
                <a href="{{ route('beasiswa.all') }}"
                    class="hopx-6 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-r-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 whitespace-nowrap transition-all ease-in-out">
                    Daftar Beasiswa
                </a>
                {{-- <a href="{{ route('applicant') }}"
                        class="px-6 py-2 text-sm font-medium text-gray-900 bg-white border-t border-b border-r border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 whitespace-nowrap transition-all ease-in-out">
            ...
            <div
                class="dropdownMenu hidden lg:hidden absolute top-[54px] right-0 bg-gray-100 w-full divide-y divide-[#e6e4e1] z-[100] flex flex-col justify-center items-end">
                <a href="{{ route('beasiswa.all') }}"
                    class="leading-none p-[15px] w-full box-border text-right hover:bg-gray-200 transition-all ease-in-out">Daftar Beasiswa</a>
                <a href="{{ route('artikel.index') }}"
                    class="leading-none p-[15px] w-full box-border text-right hover:bg-gray-200 transition-all ease-in-out">Kembali ke Kemahasiswaan</a>
            </div>
