                                        ...
                                        <div
                                            ...
                                            @php
                                                $canEdit =
                                                    ...
                                                    \Carbon\Carbon::parse($a->beasiswa?->deadline)->isAfter(now());
                                                $canDelete = \Carbon\Carbon::parse($a->beasiswa?->deadline)->isAfter(
                                                    now(),
                                                );
                                            @endphp
                                    ...
                                    <div class="hidden lg:flex lg:flex-row lg:justify-center lg:space-x-4">
                                        ...
                                        @php
                                            $canEdit =
                                                $a->status === 'revision_needed' ||
                                                \Carbon\Carbon::parse($a->beasiswa?->deadline)->isAfter(now());
                                            $canDelete = \Carbon\Carbon::parse($a->beasiswa?->deadline)->isAfter(now());
                                        @endphp
